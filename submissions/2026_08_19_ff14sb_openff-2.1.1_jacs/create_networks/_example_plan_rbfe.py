...
PARTIAL_CHARGE = "openeye_am1bccelf10"  # for the ligand and cofactors
FORCEFIELD = "openff-2.1.1"  # available [openmmforcefields SystemGenerator](https://github.com/openmm/openmmforcefields?tab=readme-ov-file#automating-force-field-management-with-systemgenerator)
...
def run_network(benchmark_set_name, benchmark_sys_name):
    ...
    benchmark_set_name : str
        The benchmark set name (e.g., "jacs_set")
    benchmark_sys_name : str
        The benchmark system name (e.g., "tyk2")
    """
                ...
                for required_key in ["system_group", "system_name"]:
                    if required_key not in mapping_annot:
                        ...
                        errors.append(
                            ...
                            f"expected '{benchmark_set_name if required_key == 'system_group' else benchmark_sys_name}', "
