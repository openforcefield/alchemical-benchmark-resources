...
BENCHMARK_SYS_NAMES = ["tyk2", "thrombin"]
PARTIAL_CHARGE = "nagl_openff-gnn-am1bcc-1.0.0.pt"  # for the ligand and cofactors
ff = ForceField("openff_no_water-3.0.0-alpha1b.offxml")
FORCEFIELD = ff.to_string()  # available [openmmforcefields SystemGenerator](https://github.com/openmm/openmmforcefields?tab=readme-ov-file#automating-force-field-management-with-systemgenerator)
LIG_NETWORK_FILE = "industry_benchmarks_network"
FILENAME_ALCHEMICALNETWORK = "alchemical_network_{}_{}.json"
OUTPUT_DIR = "outputs"
