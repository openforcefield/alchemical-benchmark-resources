...
# OpenFF 3.0.0-alpha1b + TIP3P RBFE

## Purpose

This submission tests **relative binding free energy (RBFE)** calculations using an **alphab version** of OpenFF 3.0.0-alpha1b with the **TIP3P water model**. This benchmark compares the Pontibus protocol performance across the full JACS diverse set (8 systems) with this experimental force field configuration.
